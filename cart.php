...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="sub-total"> sub total : <span>Rp <?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?></div>
   ...
   <p>grand total : <span>Rp <?= number_format($grand_total, 0, ',', '.'); ?></span></p>
      ...
      <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('delete semua item darikeranjang?');">delete item</a>
